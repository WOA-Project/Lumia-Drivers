...
set Folder=D:\Lumia-Drivers-main\adaptationkits\FOS
...
for /f %%f in ('dir /b /s %Folder%\REG.CITYMAN\SOFTWARE\*.reg') do reg import %%f
reg unload HKLM\RTS

reg load HKLM\RTS %MainOS%\Windows\System32\config\SYSTEM
for /f %%f in ('dir /b /s %Folder%\REG.CITYMAN\SYSTEM\*.reg') do reg import %%f
